	    ...
	    switch(*format)
	      ...
	      case 'd':
	          ...
	          if (*format == 'd')
	            ...
	            pc += printi ( va_arg( args, unsigned int ), 16, 0, width, pad, 'a');
	          continue;
//	        case 'd':
//	            pc += printi ( va_arg( args, int ), 10, 1, width, pad, 'a');
//	            continue;
...
//	            continue;
	      case 'l':
	          ...
	          if (*format == 'd')
	            ...
	            pc += printi ( va_arg( args, unsigned long ), 10, 0, width, pad, 'a');
	          else if (*format == 'x')
	            pc += printi ( va_arg( args, unsigned long ), 16, 0, width, pad, 'a');
	          continue;
	      }
	    }
	  else
