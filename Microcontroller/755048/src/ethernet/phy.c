...
static word XDATA phy_Control = 0;
...
// Note:
// ----------------------------------------------------------------------------
void phy_ReadReg(byte regaddr, word XDATA* pvalue)
{
	byte	temp, isr;
...
// Note:
// ----------------------------------------------------------------------------
void phy_WriteReg(byte regaddr, word value)
{
	byte	temp, isr;
...
{
	word XDATA	phyctrl, phyanar, tempshort;
...
// Note:
// ----------------------------------------------------------------------------
word PHY_CheckMediaType(void)
{
	word XDATA	phylinkstatus = 0;
	word XDATA	tempshort;
