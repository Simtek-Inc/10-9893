...
//4/3/2019
//;************************************************
//; Revision A: updated baudrate setting to 9600 @ 8MHz
//; May 8, 2023
//;************************************************
#include<aduc841.h>
#include<absacc.h>
...
//;************************************************
unsigned char RS_micro_firmware[] =  {0x75,0x51,0x28,0x41};
...
{ 	
	...
	T3CON	= 0x85;						// 9600K BPS	
	T3FD	= 0x28;						// DEFAULT IS 9600K BAUD
